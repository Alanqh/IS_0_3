...
from customerservice.views import customerservice_home, customer_information, stu_service_records
...
urlpatterns = [
    ...
    path('stu_service_records/', login_required(stu_service_records), name='stu_service_records'),
