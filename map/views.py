...
def map_search(request):
    if request.method == 'POST':
        ...
        if result:
            ...
            return render(request, 'search_result.html', {'province': province, 'city': city, 'lng': lng, 'lat': lat})

        error_message = '未找到该地址'
        return render(request, 'search.html', {'error_message': error_message, 'province_data': province_data})

    return render(request, 'search.html', {'province_data': province_data})


def get_cities(request):
    province = request.GET.get('province')
    cities = province_data.get(province, [])
